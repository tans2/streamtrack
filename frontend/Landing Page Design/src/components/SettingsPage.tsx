...
export default function SettingsPage({ onNavigate }: SettingsPageProps) {
  ...
  const handleNestedChange = (category: string, field: string, value: boolean) => {
    setSettings(prev => ({
      ...prev,
      [category]: {
          ...
          <Card className="bg-card border-border shadow-lg">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Select value={settings.country} onValueChange={(value: string) => handleInputChange('country', value)}>
